...
class knowledgeringppgt_PopularPostsWidget extends WP_Widget {
   ...
   function widget($args, $instance) {
      ...
      if(isset($instance['kppg_numberposts']) && !empty($instance['kppg_numberposts'])){ $kppg_numberposts = $instance['kppg_numberposts'];}else {$kppg_numberposts = 5;}
		...
		if(isset($instance['kppg_widget_title_header']) && !empty($instance['kppg_widget_title_header'])){$kppg_widget_title_header = $instance['kppg_widget_title_header'];} else {$kppg_widget_title_header = "h3";}
		if(isset($instance['kppg_widget_title_header_classname']) && !empty($instance['kppg_widget_title_header_classname'])){$kppg_widget_title_header_classname = $instance['kppg_widget_title_header_classname'];} else {$kppg_widget_title_header_classname = "h3";}
   ...
   if(isset($instance['kppg_numberposts']) && !empty($instance['kppg_numberposts'])){
       ...
       $kppg_widget_title_header = esc_attr($instance['kppg_widget_title_header']);}else { $kppg_widget_title_header="h3";}
